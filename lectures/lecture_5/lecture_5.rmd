...
```{r bird_rich, echo=FALSE}
    ...
    spplot(figDat, 'Rich', col.regions=heat.colors(20), scales=list(cex=1, draw=TRUE), 
...
```{r simple_glm, echo=FALSE, fig.width=12, fig.height=5, point.size=20}
...
```{r simple_pred, echo=FALSE, fig.width=12, fig.height=4}
...
```{r correlogram, echo=FALSE, cache=TRUE, fig.width=12, fig.height=6}
...
```{r variogram, echo=FALSE, fig.width=12, fig.height=6}
...
```{r gls1, fig.width=6, fig.height=6}
...
```{r gls2, fig.width=6, fig.height=6}

...
The approach below allows us to turn a data frame with coordinates in a column into a point vector data sources. The example here creates point locations for capital cities.
